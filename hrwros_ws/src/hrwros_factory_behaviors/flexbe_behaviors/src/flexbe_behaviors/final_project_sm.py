...
The three robots in the factory move to process the parts
	...
	def create(self):
		...
		pick1_group = 'robot1'
		robot1_loc = Pose2D(x=3.8, y=2.1, theta=0.0)
		...
		with _state_machine:
			...
			# x:1114 y:345
			OperatableStateMachine.add('Compute place Turtlebot 1',
										ComputeGraspState(group=pick1_group, offset=0.0, joint_names=names1, tool_link=gripper1, rotation=3.1415),
										transitions={'continue': 'Move R1 to place 2', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'pose': 'pose_turtlebot', 'joint_values': 'place1_configuration', 'joint_names': 'joint_names'})

			# x:1122 y:277
			OperatableStateMachine.add('LocateTurtlebot1',
										LocateFactoryDeviceState(model_name='mobile_base', output_frame_id='world'),
										transitions={'succeeded': 'Compute place Turtlebot 1', 'failed': 'failed'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off},
			...
			OperatableStateMachine.add('Deactivate Gripper 1',
										...
										transitions={'continue': 'Move R1 back Home again', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off})
			...
			OperatableStateMachine.add('Activate Gripper 2',
										...
										transitions={'continue': 'LocateTurtlebot2', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off})
			...
			OperatableStateMachine.add('Move R2 to pick',
										...
										transitions={'reached': 'Move R2 back Home again', 'planning_failed': 'failed', 'control_failed': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off},
										remapping={'joint_values': 'pick2_configuration', 'joint_names': 'joint_names'})

			# x:1111 y:542
			OperatableStateMachine.add('Move R1 back Home again',
										hrwros_factory_states__SrdfStateToMoveit(config_name='R1Home', move_group=pick1_group, action_topic='/move_group', robot_name=''),
										transitions={'reached': 'Move to Robot 2', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off, 'param_error': Autonomy.Off},
										remapping={'config_name': 'config_name', 'move_group': 'move_group', 'robot_name': 'robot_name', 'action_topic': 'action_topic', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})

			# x:979 y:545
			OperatableStateMachine.add('Move to Robot 2',
										hrwros_factory_states__MoveBaseState(),
										transitions={'arrived': 'Move R2 back to Home', 'failed': 'failed'},
										autonomy={'arrived': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'waypoint': 'robot2_loc'})

			# x:221 y:541
			OperatableStateMachine.add('LocateTurtlebot2',
										LocateFactoryDeviceState(model_name='mobile_base', output_frame_id='world'),
										transitions={'succeeded': 'Compute place Turtlebot 2', 'failed': 'failed'},
										autonomy={'succeeded': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'pose': 'pose_turtlebot'})
			...
			OperatableStateMachine.add('Deactivate Gripper 2',
										...
										transitions={'continue': 'Move R2 back Home again and again', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off})

			# x:0 y:198
			OperatableStateMachine.add('Move R2 back Home again and again',
			...
			OperatableStateMachine.add('Move R1 back Home',
										hrwros_factory_states__SrdfStateToMoveit(config_name='R1Home', move_group=pick1_group, action_topic='/move_group', robot_name=''),
										transitions={'reached': 'Move to Robot 1', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off, 'param_error': Autonomy.Off},
										remapping={'config_name': 'config_name', 'move_group': 'move_group', 'robot_name': 'robot_name', 'action_topic': 'action_topic', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})
			...
			# x:1140 y:208
			OperatableStateMachine.add('Move to Robot 1',
										hrwros_factory_states__MoveBaseState(),
										transitions={'arrived': 'LocateTurtlebot1', 'failed': 'failed'},
										autonomy={'arrived': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'waypoint': 'robot1_loc'})

			# x:1135 y:408
			OperatableStateMachine.add('Move R1 to place 2',
										hrwros_factory_states__SrdfStateToMoveit(config_name='R1Place', move_group=pick1_group, action_topic='/move_group', robot_name=""),
			...
			OperatableStateMachine.add('Move R2 back to Home',
										...
										transitions={'reached': 'Detect Part Camera 2', 'planning_failed': 'failed', 'control_failed': 'failed', 'param_error': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off, 'param_error': Autonomy.Off},
										remapping={'config_name': 'config_name', 'move_group': 'move_group', 'robot_name': 'robot_name', 'action_topic': 'action_topic', 'joint_values': 'joint_values', 'joint_names': 'joint_names'})

			# x:59 y:538
			OperatableStateMachine.add('Compute place Turtlebot 2',
										ComputeGraspState(group=pick2_group, offset=0.0, joint_names=names2, tool_link=gripper2, rotation=3.1415),
										transitions={'continue': 'Move R2 to pick', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
										remapping={'pose': 'pose_turtlebot', 'joint_values': 'pick2_configuration', 'joint_names': 'joint_names'})

			# x:0 y:407
			OperatableStateMachine.add('Move R2 back Home again',
										hrwros_factory_states__SrdfStateToMoveit(config_name='R2Home', move_group=pick2_group, action_topic='/move_group', robot_name=''),
